...
const Home = () => {
    ...
    return (
        <div  className='sm:my-auto sm:grid sm:grid-cols-3 sm:p-[2rem] gap-[20px]'>
            {products.map((product)=> <div key={product.id} className='sm:w-[300px] flex flex-col border border-gray-200 items-center'>
                <img src={product.image} alt={product.name} className='w-[150px] h-[200px]'/>
